...
Additionally, I will remove duplicate rows using the distinct function.
...
So, I need to make sure that other iterations of those categories get
relabeled to one of my 4 categories.
